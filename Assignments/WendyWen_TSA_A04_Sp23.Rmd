...
plot(dif[,1],type="l",col="brown",ylab= paste0(col_names[1]," [Trillion Btu]"),
...
plot(Time, det[,1], type="l",col="orange", xlab = "Time", ylab= paste0(col_names[1]," [Trillion Btu]"),
     main=paste0("Detrended ",col_names[1]))
```
