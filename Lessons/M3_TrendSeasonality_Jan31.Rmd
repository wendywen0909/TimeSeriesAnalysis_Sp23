...
```{r}
ts_data <- ts(inflow_data[,2:16],start = c(1931,1), end = c(1977,8), frequency=12)
head(ts_data)
```
...
```{r acf}
Acf(ts_data[,1],type="correlation",lag.max = 40,main = "ACF of HP1")

Pacf(ts_data[,1],lag.max = 40,main = "PACF of HP1")
```
